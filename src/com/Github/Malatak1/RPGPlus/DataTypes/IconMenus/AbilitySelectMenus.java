...
public class AbilitySelectMenus {
	...
	public IconMenu createAbilityMenu() {
		...
		IconMenu abilitySelectMenu = new IconMenu("Ability Selection", 9, new IconMenu.OptionClickEventHandler() {
			...
			public void onOptionClick(OptionClickEvent event) {
				...
				case 1: db.setAbility(p, new FireballAbility()); p.sendMessage(ChatColor.YELLOW + "You have selected " + event.getName()); break;
				case 2: db.setAbility(p, new FireboltAbility()); p.sendMessage(ChatColor.YELLOW + "You have selected " + event.getName()); break;
